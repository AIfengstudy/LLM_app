...
"")
        ...
        self.homePag_btn.setCursor(QCursor(Qt.ArrowCursor))
...
"}")
        ...
        self.envDpl_btn.setCursor(QCursor(Qt.ArrowCursor))
...
"}")
        ...
        self.dataGen_btn.setCursor(QCursor(Qt.ArrowCursor))
...
"}")
        ...
        self.modelFtn_btn.setCursor(QCursor(Qt.ArrowCursor))
...
"}")
        ...
        self.modelTra_btn.setCursor(QCursor(Qt.ArrowCursor))
...
"}")
        ...
        self.existSys_btn.setCursor(QCursor(Qt.ArrowCursor))
